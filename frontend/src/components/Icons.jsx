...
export function Icon({ name }) {
  const paths = {
    ...
    image: 'M5 5h14a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm2 10 3-3 2.5 2.5L15 10l4 5H7Zm2-6.5a1.5 1.5 0 1 0 1.5 1.5A1.5 1.5 0 0 0 9 8.5Z',
    smile: 'M12 3a9 9 0 1 0 9 9 9 9 0 0 0-9-9Zm-3 7a1.2 1.2 0 1 1 0 2.4A1.2 1.2 0 0 1 9 10Zm6 0a1.2 1.2 0 1 1 0 2.4A1.2 1.2 0 0 1 15 10Zm-6.1 4h6.2a3.6 3.6 0 0 1-6.2 0Z',
    calendar:
    ...
    repost: 'M7 7h9l-2-2 1.4-1.4L20.8 9l-5.4 5.4L14 13l2-2H7a3 3 0 0 0-3 3v1H2v-1a5 5 0 0 1 5-5Zm10 6H8l2 2-1.4 1.4L3.2 11l5.4-5.4L10 7l-2 2h9a5 5 0 0 1 5 5v1h-2v-1a3 3 0 0 0-3-3Z',
    heart:
    ...
    share: 'M18 16a3 3 0 0 0-2.4 1.2L9.4 13a3.3 3.3 0 0 0 0-2l6.2-4.2A3 3 0 1 0 14.8 5L8.6 9.2a3 3 0 1 0 0 5.6l6.2 4.2A3 3 0 1 0 18 16Z',
  }
